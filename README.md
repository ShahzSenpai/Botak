...
```bash
> git clone https://github.com/ShahzSenpai/botak.git
> cd botak
```
...
### Information
- Change ownerNumber on [this section](https://github.com/ShahzSenpai/Botak/blob/master/settings/setting.json#L2)
